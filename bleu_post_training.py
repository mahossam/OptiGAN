...
BLEU_samples = 999999 
#BLEU_samples = 200
bleu_2 = Bleu("",'data/testdata/test_coco.txt', 2, sample_size=BLEU_samples)
bleu_3 = Bleu("",'data/testdata/test_coco.txt', 3, sample_size=BLEU_samples)
bleu_4 = Bleu("",'data/testdata/test_coco.txt', 4, sample_size=BLEU_samples)
bleu_5 = Bleu("",'data/testdata/test_coco.txt', 5, sample_size=BLEU_samples)
bleu2_list = list()
bleu3_list = list()
bleu4_list = list()
bleu5_list = list()
