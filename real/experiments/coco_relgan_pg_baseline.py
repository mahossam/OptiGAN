...
# Arguments
architecture = ['rmc_vanilla_pg', 'rmc_vanilla_pg', 'rmc_vanilla_pg', 'rmc_vanilla_pg', 'rmc_vanilla_pg', 'rmc_vanilla_pg', 'rmc_vanilla_pg', 'rmc_vanilla_pg']
...
outdir = os.path.join(cwd, 'out', time.strftime("%Y%m%d"), dataset, f"RELGAN_pg_bline", datetime.utcnow().strftime("%H%M%S%f"))
