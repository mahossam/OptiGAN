...
outdir = os.path.join(cwd, 'out', time.strftime("%Y%m%d"), dataset, f"multi_{rl_use_multinomial}_rl_only_{rl_only}_pg_bline_{pg_baseline}", datetime.utcnow().strftime("%H%M%S%f"))
