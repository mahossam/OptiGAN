...
# architecture = ['lstm_vanilla_pg_new_init', 'lstm_vanilla_pg_new_init', 'lstm_vanilla_pg_new_init', 'lstm_vanilla_pg_new_init', 'lstm_vanilla_pg_new_init', 'lstm_vanilla_pg_new_init', 'lstm_vanilla_pg_new_init', 'lstm_vanilla_pg_new_init']
...
outdir = os.path.join(cwd, 'out', time.strftime("%Y%m%d"), dataset, f"lstmgan_rl_only_{rl_only}_pg_bline{pg_baseline}_faster", datetime.utcnow().strftime("%H%M%S%f"))
...
args = [
    ...
    '--adapt', adapt,
    '--pg_baseline_val', pg_baseline_val,
