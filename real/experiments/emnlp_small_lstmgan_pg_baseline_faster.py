...
outdir = os.path.join(cwd, 'out', time.strftime("%Y%m%d"), dataset, f"lstmgan_rl_only_{rl_only}_pg_bline_{pg_baseline}_bsl{pg_baseline_val}_mc_{mc_samples}", datetime.utcnow().strftime("%H%M%S%f"))
