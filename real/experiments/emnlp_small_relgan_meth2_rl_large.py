...
architecture = ['lstm_vanilla_pg', 'lstm_vanilla_pg', 'lstm_vanilla_pg', 'lstm_vanilla_pg', 'lstm_vanilla_pg', 'lstm_vanilla_pg', 'lstm_vanilla_pg', 'lstm_vanilla_pg']
...
outdir = os.path.join(cwd, 'out', time.strftime("%Y%m%d"), dataset, f"multi_{rl_use_multinomial}_rl_only_{rl_only}_alpha_{rl_alpha}_meth_{rl_method}", datetime.utcnow().strftime("%H%M%S%f"))
