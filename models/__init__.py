...
from models import rmc_vanilla, rmc_att, rmc_vdcnn, lstm_vanilla, lstm_vanilla_pg, lstm_vanilla_new_init, lstm_vanilla_pg_new_init, rmc_vanilla_pg, lstm_vanilla_new_init_contin
